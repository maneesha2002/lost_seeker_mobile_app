...
class SignupPage extends StatelessWidget {
  ...
  bool _areTextFieldsFilled(BuildContext context) {
    final username = ''; // Get username value from TextField
    final email = ''; // Get email value from TextField
    final contact = ''; // Get contact value from TextField
    final password = ''; // Get password value from TextField
